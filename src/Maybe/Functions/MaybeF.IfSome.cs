...
{
	/// <summary>
	/// Run <paramref name="ifSome"/> if <paramref name="maybe"/> is a <see cref="Internals.Some{T}"/>,
	/// and returns the original <paramref name="maybe"/>
	/// </summary>
	/// <typeparam name="T">Maybe value type</typeparam>
	/// <param name="maybe">Input Maybe</param>
	/// <param name="ifSome">Will receive <see cref="Some{T}.Value"/> if this is a <see cref="Internals.Some{T}"/></param>
