...
public class IfNull_Tests : Abstracts.IfNull_Tests
{
	...
	{
		Test06((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome, F.DefaultHandler));
		Test06((mbe, ifNull, ifSome) => mbe.IfNull(() => F.Some(ifNull()), x => F.Some(ifSome(x))));
	}

	[Fact]
	public override void Test07_Some_With_Value__Runs_IfSome()
	{
		Test07((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome, F.DefaultHandler));
		Test07((mbe, ifNull, ifSome) => mbe.IfNull(() => F.Some(ifNull()), x => F.Some(ifSome(x))));
	}

	[Fact]
	public override void Test08_None_With_NullValueMsg__Runs_IfNull()
	{
		Test08((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome, F.DefaultHandler));
		Test08((mbe, ifNull, ifSome) => mbe.IfNull(() => F.Some(ifNull()), x => F.Some(ifSome(x))));
	}

	[Fact]
	public override void Test09_None_With_Msg__Returns_None()
	{
		Test09((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome, F.DefaultHandler));
		Test09((mbe, ifNull, ifSome) => mbe.IfNull(() => F.Some(ifNull()), x => F.Some(ifSome(x))));
	}

	[Fact]
	public override void Test10_Exception_In_IfNull__Uses_Handler()
	{
		Test10((mbe, ifNull, ifSome, handler) => mbe.IfNull(ifNull, ifSome, handler));
	}

	[Fact]
	public override void Test11_Exception_In_IfSome__Uses_Handler()
	{
		Test11((mbe, ifNull, ifSome, handler) => mbe.IfNull(ifNull, ifSome, handler));
	}

	[Fact]
	public override void Test12_Exception_In_IfNull__Uses_DefaultHandler()
	{
		Test12((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome));
	}

	[Fact]
	public override void Test13_Exception_In_IfSome__Uses_DefaultHandler()
	{
		Test13((mbe, ifNull, ifSome) => mbe.IfNull(ifNull, ifSome));
	}
