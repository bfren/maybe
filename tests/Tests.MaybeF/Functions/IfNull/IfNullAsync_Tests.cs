...
public class IfNullAsync_Tests : Abstracts.IfNullAsync_Tests
{
	...
	public override async Task Test06_Some_With_Null__Runs_IfNull()
	{
		...
		await Test06((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), F.DefaultHandler));
		await Test06((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), ifNull, ifSome, F.DefaultHandler));
		await Test06((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => F.Some(ifNull().GetAwaiter().GetResult()), x => F.Some(ifSome(x).GetAwaiter().GetResult())));
	...
	public override async Task Test07_Some_With_Value__Runs_IfSome()
	{
		...
		await Test07((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), F.DefaultHandler));
		await Test07((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), ifNull, ifSome, F.DefaultHandler));
		await Test07((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => F.Some(ifNull().GetAwaiter().GetResult()), x => F.Some(ifSome(x).GetAwaiter().GetResult())));
	...
	public override async Task Test08_None_With_NullValueMsg__Runs_IfNull()
	{
		...
		await Test08((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), F.DefaultHandler));
		await Test08((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), ifNull, ifSome, F.DefaultHandler));
		await Test08((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => F.Some(ifNull().GetAwaiter().GetResult()), x => F.Some(ifSome(x).GetAwaiter().GetResult())));
	...
	public override async Task Test09_None_With_Msg__Returns_None()
	{
		...
		await Test09((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), F.DefaultHandler));
		await Test09((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), ifNull, ifSome, F.DefaultHandler));
		await Test09((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => F.Some(ifNull().GetAwaiter().GetResult()), x => F.Some(ifSome(x).GetAwaiter().GetResult())));
	...
	public override async Task Test10_Exception_In_IfNull__Uses_Handler()
	{
		...
		await Test10((mbe, ifNull, ifSome, handler) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), handler));
	...
	public override async Task Test11_Exception_In_IfSome__Uses_Handler()
	{
		...
		await Test11((mbe, ifNull, ifSome, handler) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult(), handler));
	...
	{
		await Test12((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult()));
	...
	{
		await Test13((mbe, ifNull, ifSome) => F.IfNullAsync(mbe.AsTask(), () => ifNull().GetAwaiter().GetResult(), x => ifSome(x).GetAwaiter().GetResult()));
