...
namespace Maybe.Functions.MaybeF_Tests.Dictionary;
...
public class GetValueOrNone_Tests : Tests.Maybe.Abstracts.Dictionary.GetValueOrNone_Tests
{
	...
	{
		Test00((dict, key) => MaybeF.DictionaryF.GetValueOrNone(dict, key));
	}
