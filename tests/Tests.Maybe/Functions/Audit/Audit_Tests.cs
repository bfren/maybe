...
public class Audit_Tests : Tests.Maybe.Abstracts.Audit_Tests
{
	...
	{
		Test00(mbe => MaybeF.Audit(mbe, null, null, null));
	}

	[Fact]
	public override void Test01_If_Unknown_Maybe_Throws_UnknownOptionException()
	{
		Test01(mbe => MaybeF.Audit(mbe, Substitute.For<Action<Maybe<int>>>(), null, null));
		Test01(mbe => MaybeF.Audit(mbe, null, Substitute.For<Action<int>>(), null));
		Test01(mbe => MaybeF.Audit(mbe, null, null, Substitute.For<Action<IReason>>()));
	}
