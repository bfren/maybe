...
public abstract class SomeIf_Tests
{
	...
	protected static void Test00(Func<Func<bool>, int, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
	...
	protected static void Test01(Func<Func<bool>, Func<int>, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var handler = Substitute.For<MaybeF.Handler>();
		var exception = new Exception();
	...
	protected static void Test02(Func<Func<bool>, Func<int>, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var handler = Substitute.For<MaybeF.Handler>();
		var exception = new Exception();
	...
	protected static void Test03(Func<Func<bool>, int, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var value = Rnd.Int;

		// Act
		var result = act(() => true, value, MaybeF.DefaultHandler);
	...
	protected static void Test04(Func<Func<bool>, Func<int>, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var value = Rnd.Int;
	...
	protected static void Test05(Func<Func<bool>, int, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var value = Rnd.Int;

		// Act
		var result = act(() => false, value, MaybeF.DefaultHandler);
	...
	protected static void Test06(Func<Func<bool>, Func<int>, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var value = Rnd.Int;
	...
	protected static void Test07(Func<Func<bool>, Func<int>, MaybeF.Handler, Maybe<int>> act)
	{
		// Arrange
		var getValue = Substitute.For<Func<int>>();

		// Act
		var result = act(() => false, getValue, MaybeF.DefaultHandler);
